...
plt.savefig(dir+'/RS_sigEn_plot_nodrift_on_T1_std.png', format = 'png', bbox_inches = 'tight', dpi = 500)
...
c_to_r_model = relaxivity.CRLinear(r1=4.5, r2=6.3)
...
for tissue_type in range(6):
    ...
    plt.savefig(dir+'/RS_conc_VIF_'+ROI[tissue_type]+'_nodrift_on_T1_std.png', format = 'png', bbox_inches = 'tight', dpi = 500)
    ...
    plt.legend();
    plt.savefig(dir+'/'+'RS_model_fit_'+ROI[tissue_type]+'_nodrift_on_T1_std.png', format = 'png', bbox_inches = 'tight', dpi = 500)
    
    print(f"vp = {vp:.4f}, ps = {ps:.6f}")
    
    #book_result= Workbook()
    book_result= openpyxl.load_workbook('/gpfs/home/wae16sru/BBB_sample_data/BBB_Michael_Code_modification/BBB_results_ADA_no_drift_on_T1_std_enh_timed100.xlsx')
    #book_result= Workbook()
    ...
    book_result.save("/gpfs/home/wae16sru/BBB_sample_data/BBB_Michael_Code_modification/BBB_results_ADA_no_drift_on_T1_std_enh_timed100.xlsx")
    
    df = pd.DataFrame(pd.read_excel('/gpfs/home/wae16sru/BBB_sample_data/BBB_Michael_Code_modification/BBB_results_ADA_no_drift_on_T1_std_enh_timed100.xlsx'))
